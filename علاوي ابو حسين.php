...
ob_start();
error_reporting(0);
define('API_KEY','7677853043:AAF_Jhtqp-LzLng7twpG_ufWlEOoOt3TTpU');
...
$Dev = array("","",""); //ID ADMIN NUMBER 1 HE CHAT
@$usernamebot = "هلو"; //UserName Bot
@$channel = "ALI_2Cbot"; // UserName Channel don't @
@$token = API_KEY;
